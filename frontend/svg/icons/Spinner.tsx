import styles from "../../styles/svg/icons/Spinner.module.scss"

const Spinner = () => {
    return (
        // <svg xmlns="http://www.w3.org/2000/svg" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 512.001 512.001" className={styles.Spinner}>
